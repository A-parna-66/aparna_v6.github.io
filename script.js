const initBg = (autoplay = true) => {
    const bgImgsNames = ['images\bg1.jpg', 'images\bg2.jpg', 'images\bg3.jpg','images\bg4.jpg','images\bg5.jpg','images\bg6.jpg','images\bg7.jpg'];
    const bgImgs = bgImgsNames.map(img => "img/" + img);

    $.backstretch(bgImgs, {duration: 1000, fade: 1000});
